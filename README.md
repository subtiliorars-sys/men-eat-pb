...
Roguelike idle arcade toy â€” four men, one jar, sticky peanut butter blobs.
...
3. Chain chomps â†’ **Frenzy**. Five misses â†’ **Stuck Shut**. Empty jar â†’ win.
...
Vertical slice v0.1 â€” chomp loop, three modifiers, Frenzy, run end screens.
